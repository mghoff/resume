...
![Matthew G. Hoff](https://media.licdn.com/dms/image/C5603AQFVuY8QMkD_mg/profile-displayphoto-shrink_400_400/0/1654775390538?e=1692230400&v=beta&t=hh7cXWAEmZn_J3hcfFKMX9VLG4t9zgPadJjJNrdHxxI){width=100%}
...
- Developed & automated the Company's Financial Trade report which summarizes daily the hedge portfolio's performance 
by intention in terms of Mark-to-Market (MtM) and realized profit/losses (PnL)
- Developed, automated, & manage numerous risk metrics (VaR, GMaR, etc.) concerning the above financial hedge position
